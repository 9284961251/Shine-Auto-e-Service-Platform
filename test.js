...
async function printReceipt() {
  ...
  const thermalEncoder = new ThermalPrinterEncoder(); // Assuming you have this library
  const encodedBytes = thermalEncoder.encode(receiptContent, { language: 'escpos' }); // Adjust language if needed
...
// Call the printReceipt function when needed (e.g., on a button click)
printReceipt();
